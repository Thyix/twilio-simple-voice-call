...
import static com.example.twiliosimplevoicecall.EventManager.EVENT_CONNECTION_DID_CONNECT;
import static com.example.twiliosimplevoicecall.EventManager.EVENT_CONNECTION_DID_DISCONNECT;
import static com.example.twiliosimplevoicecall.EventManager.EVENT_DEVICE_DID_RECEIVE_INCOMING;
import static com.example.twiliosimplevoicecall.EventManager.EVENT_DEVICE_NOT_READY;
import static com.example.twiliosimplevoicecall.EventManager.EVENT_DEVICE_READY;
...
*/
    ...
    public void connect(ReadableMap params) {
        ...
        activeCall = Voice.connect(getReactApplicationContext(), accessToken, callListener);
    }
